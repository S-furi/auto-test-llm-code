...
public class JavaLLMCodeGenerator implements LLMCodeGenerator {
    private LLMCodeGeneratorImpl codeGenerator;

    public JavaLLMCodeGenerator(final boolean setPrePrompt, final PromptBasedAgent agent) {
    ...
    private String cleanUpResponse(final String rawResponse) {
